...
const HS_GRAVITY = 1150; // (antes 950) FIX "saltan con gravedad 0": pesa más, cae más rápido
const HS_HEAD_R = 36;
...
const HS_JUMP_VY = -560; // (antes -600) salto un poco más corto, a tono con la gravedad nueva
const HS_GOAL_W = 50;
const HS_GOAL_H = 175;
...
function hsDrawBoot(ctx, p, bootPose, color, dark) {
  ...
  ctx.fill(body);
  // Contorno "toon" un poco más grueso - se nota más el estilo caricaturesco
  ctx.strokeStyle = "#0a0a0c";
  ctx.lineWidth = 2 / HS_BOOT_VISUAL_SCALE;
  ctx.lineJoin = "round";
  ctx.stroke(body);
